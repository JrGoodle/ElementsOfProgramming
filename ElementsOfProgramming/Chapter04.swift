...
func select_1_2<DomainR: Regular>(a: DomainR, b: DomainR, r: Relation<DomainR>) -> DomainR {
    // Precondition: $\func{weak\_ordering}(r)$
    if r(b, a) { return a }
    return b
}

func select_0_3<DomainR: Regular>(a: DomainR, b: DomainR, c: DomainR, r: Relation<DomainR>) -> DomainR {
    return select_0_2(a: select_0_2(a: a, b: b, r: r), b: c, r: r)
}

func select_2_3<DomainR: Regular>(a: DomainR, b: DomainR, c: DomainR, r: Relation<DomainR>) -> DomainR {
    return select_1_2(a: select_1_2(a: a, b: b, r: r), b: c, r: r)
}

func select_1_3_ab<DomainR: Regular>(a: DomainR, b: DomainR, c: DomainR, r: Relation<DomainR>) -> DomainR {
    if !r(c, b) { return b }          // $a$, $b$, $c$ are sorted
    return select_1_2(a: a, b: c, r: r) // $b$ is not the median
}

func select_1_3<DomainR: Regular>(a: DomainR, b: DomainR, c: DomainR, r: Relation<DomainR>) -> DomainR {
    if r(b, a) { return select_1_3_ab(a: b, b: a, c: c, r: r) }
    return select_1_3_ab(a: a, b: b, c: c, r: r)
}

func select_1_4_ab_cd<DomainR: Regular>(a: DomainR, b: DomainR, c: DomainR, d: DomainR, r: Relation<DomainR>) -> DomainR {
    if r(c, a) { return select_0_2(a: a, b: d, r: r) }
    return select_0_2(a: b, b: c, r: r)
}

func select_1_4_ab<DomainR: Regular>(a: DomainR, b: DomainR, c: DomainR, d: DomainR, r: Relation<DomainR>) -> DomainR {
    if r(d, c) { return select_1_4_ab_cd(a: a, b: b, c: d, d: c, r: r) }
    return select_1_4_ab_cd(a: a, b: b, c: c, d: d, r: r)
}

func select_1_4<DomainR: Regular>(a: DomainR, b: DomainR, c: DomainR, d: DomainR, r: Relation<DomainR>) -> DomainR {
...
func select_0_2<DomainR: Regular>(ia: Int, ib: Int, a: DomainR, b: DomainR, r: Relation<DomainR>) -> DomainR {
    if compareStrictOrReflexive(ia < ib)(b, a, r) { return b }
    return a
}

func select_1_2<DomainR: Regular>(ia: Int, ib: Int, a: DomainR, b: DomainR, r: Relation<DomainR>) -> DomainR {
    if compareStrictOrReflexive(ia < ib)(b, a, r) { return a }
    return b
}

func select_1_4_ab_cd<DomainR: Regular>(ia: Int, ib: Int, ic: Int, id: Int, a: DomainR, b: DomainR, c: DomainR, d: DomainR, r: Relation<DomainR>) -> DomainR {
...
func select_1_4_ab<DomainR: Regular>(ia: Int, ib: Int, ic: Int, id: Int, a: DomainR, b: DomainR, c: DomainR, d: DomainR, r: Relation<DomainR>) -> DomainR {
...
func select_1_4<DomainR: Regular>(ia: Int, ib: Int, ic: Int, id: Int, a: DomainR, b: DomainR, c: DomainR, d: DomainR, r: Relation<DomainR>) -> DomainR {
...
func select_2_5_ab_cd<DomainR: Regular>(ia: Int, ib: Int, ic: Int, id: Int, ie: Int, a: DomainR, b: DomainR, c: DomainR, d: DomainR, e: DomainR, r: Relation<DomainR>) -> DomainR {
    if compareStrictOrReflexive(ia < ic)(c, a, r) {
...
func select_2_5_ab<DomainR: Regular>(ia: Int, ib: Int, ic: Int, id: Int, ie: Int, a: DomainR, b: DomainR, c: DomainR, d: DomainR, e: DomainR, r: Relation<DomainR>) -> DomainR {
    if compareStrictOrReflexive(ic < id)(d, c, r) {
...
func select_2_5<DomainR: Regular>(ia: Int, ib: Int, ic: Int, id: Int, ie: Int, a: DomainR, b: DomainR, c: DomainR, d: DomainR, e: DomainR, r: Relation<DomainR>) -> DomainR {
    if compareStrictOrReflexive(ia < ib)(b, a, r) {
...
func median_5<DomainR: Regular>(a: DomainR, b: DomainR, c: DomainR, d: DomainR, e: DomainR, r: Relation<DomainR>) -> DomainR {
